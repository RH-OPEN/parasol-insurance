...
これまでのところ、この {ic-lab} ではhttps://huggingface.co/mistralai/Mistral-7B-Instruct-v0.2[Mistral-7B Instruct v2,window=_blank]を使用してきました。他のモデルよりは軽量ですが、それでもかなり重く、実行するには大きな GPU が必要です。CPU のみで実行する小さなモデルでも同じくらい良い結果が得られるでしょうか? 試してみましょう!
